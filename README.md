...
<head>
  ...
  <title>DawnCraft</title>

  <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@500;700&family=Inter:wght@300;400&display=swap" rel="stylesheet">
  ...
  <style>
    ...
    * {
    ...
    body {
      ...
      background: radial-gradient(circle at top, #1a1d2b, var(--bg));
      color: var(--text);
      line-height: 1.6;
    }
...
<body>
  ...
  <section class="hero">
    <h1>DawnCraft</h1>
    <p>A reimagined Minecraft experience</p>

    <div class="buttons">
      <a href="#" class="btn">Download Modpack</a>
  ...
  <!-- ABOUT -->
  <section>
    <h2>What is DawnCraft?</h2>
    <p>
      DawnCraft is a carefully curated modpack focused on immersion,
      exploration, and progression.
      <br><br>
      Designed for smooth performance and long-term worlds,
      it blends modern mechanics with a grounded fantasy feel.
    </p>
  </section>
  ...
  <section>
    ...
    <div class="cards">
      <div class="card">
        <h3>Immersive Progression</h3>
        <p>
          Meaningful advancement with guided progression
          that rewards exploration and mastery.
        </p>
      </div>
      ...
      <div class="card">
        ...
        <p>
          Configured for smooth gameplay without sacrificing visuals.
        </p>
      </div>
      ...
      <div class="card">
        ...
        <p>
          Balanced for both solo play and SMP environments.
        </p>
      </div>
    </div>
  </section>
  ...
  <!-- DOWNLOAD -->
  <section>
    <h2>Download DawnCraft</h2>

    <div class="cards">
      <div class="card">
        <h3>CurseForge</h3>
        <p>Recommended launcher</p>
      </div>
  ...
  <!-- FOOTER -->
  <footer>
    © DawnCraft • Not affiliated with Mojang Studios
  </footer>
